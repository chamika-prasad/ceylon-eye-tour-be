...
`ALTER TABLE payments
  ADD COLUMN paymentType INT NOT NULL DEFAULT 0,
  ADD COLUMN secondPaymentRequired BOOLEAN NOT NULL DEFAULT FALSE,
  ADD COLUMN sourceUrl VARCHAR(255) DEFAULT NULL;`
];
