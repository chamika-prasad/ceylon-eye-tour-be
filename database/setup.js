...
const SQL_STATEMENTS = [
  ...
  FOREIGN KEY (customer_id) REFERENCES users(id),
  is_deleted BOOL NOT NULL DEFAULT 0,
  booking_no INT NOT NULL AUTO_INCREMENT UNIQUE,
  ...
  secondPaymentRequired BOOLEAN NOT NULL DEFAULT FALSE,
  sourceUrl VARCHAR(255) DEFAULT NULL,
  remainBalance INT NOT NULL DEFAULT 0,
  ...
  `ALTER TABLE payments ADD COLUMN is_refunded BOOLEAN NOT NULL DEFAULT FALSE;`,
  `ALTER TABLE payments ADD COLUMN refund_note TEXT DEFAULT NULL;`,
